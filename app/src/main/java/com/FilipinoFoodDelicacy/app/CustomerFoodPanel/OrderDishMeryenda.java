...
public class OrderDishMeryenda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_dish_meryenda);


        Foodname = (TextView) findViewById(R.id.food_nameM);
        ChefName = (TextView) findViewById(R.id.chef_nameM);
        ChefLoaction = (TextView) findViewById(R.id.chef_locationM);
        FoodPrice = (TextView) findViewById(R.id.food_priceM);
        FoodDescription = (TextView) findViewById(R.id.food_descriptionM);
        imageView = (ImageView) findViewById(R.id.imageM);
        additem = (ElegantNumberButton) findViewById(R.id.number_btnM);
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child("Meryenda").child(Region).child(City).child(ChefID).child(RandomId);
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Glide.with(OrderDishMeryenda.this).load(updateDishModel.getImageURL()).into(imageView);
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    if (ChefID.equals(cart1.getChefId())) {
                                        data = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child("Meryenda").child(Region).child(City).child(ChefID).child(RandomId);
                                                ...
                                                if (num != 0) {
                                                    ...
                                                    reference.setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        ...
                                                        public void onSuccess(Void aVoid) {
                                                            ...
                                                            Toast.makeText(OrderDishMeryenda.this, "Added to cart", Toast.LENGTH_SHORT).show();
                                                        }
                                                    });
                                    ...
                                    {
                                        AlertDialog.Builder builder = new AlertDialog.Builder(OrderDishMeryenda.this);
                                        ...
                                        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                dialog.dismiss();
                                                Intent intent = new Intent(OrderDishMeryenda.this, CustomerFoodPanel_BottomNavigation.class);
