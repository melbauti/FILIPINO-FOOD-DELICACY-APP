...
public class CustomerHomeLunchAdapter extends RecyclerView.Adapter<CustomerHomeLunchAdapter.ViewHolder> {
    ...
    public CustomerHomeLunchAdapter(Context context, List<UpdateDishModel>updateDishModellist)
    {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mcontext).inflate(R.layout.customer_menudish_lunch,parent,false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(mcontext, OrderDishLunch.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageView=itemView.findViewById(R.id.menu_imageL);
            Dishname=itemView.findViewById(R.id.dishnameL);
            price=itemView.findViewById(R.id.dishpriceL);
            additem=itemView.findViewById(R.id.number_btnrL);
