...
public class CustomerHomeMeryendaAdapter extends RecyclerView.Adapter<CustomerHomeMeryendaAdapter.ViewHolder> {
    ...
    public CustomerHomeMeryendaAdapter(Context context, List<UpdateDishModel>updateDishModellist)
    {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mcontext).inflate(R.layout.customer_menudish_meryenda,parent,false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(mcontext, OrderDishMeryenda.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageView=itemView.findViewById(R.id.menu_imageM);
            Dishname=itemView.findViewById(R.id.dishnameM);
            price=itemView.findViewById(R.id.dishpriceM);
            additem=itemView.findViewById(R.id.number_btnrM);
