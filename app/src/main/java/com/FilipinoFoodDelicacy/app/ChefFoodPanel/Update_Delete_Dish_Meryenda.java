...
import com.FilipinoFoodDelicacy.app.ChefFoodPanel_BottomNavigation;
...
public class Update_Delete_Dish_Meryenda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update__delete__dish_meryenda);

        desc = (TextInputLayout) findViewById(R.id.Mdescription);
        qty = (TextInputLayout) findViewById(R.id.Mquantity);
        pri = (TextInputLayout) findViewById(R.id.Mprice);
        Dishname = (EditText) findViewById(R.id.Mdish_name);
        imageButton = (ImageButton) findViewById(R.id.Mimageupload);
        Update_dish = (Button) findViewById(R.id.MUpdatedish);
        Delete_dish = (Button) findViewById(R.id.MDeletedish);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Update_dish.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        dishes = Dishname.getText().toString().trim();
                ...
                Delete_dish.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(Update_Delete_Dish_Meryenda.this);
                        builder.setMessage("Are you sure you want to Delete Dish");
                        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {

                                firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child("Meryenda").child(Region).child(City).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID).removeValue();

                                AlertDialog.Builder food = new AlertDialog.Builder(Update_Delete_Dish_Meryenda.this);
                                food.setMessage("Your Dish has been Deleted");
                                food.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {

                                        startActivity(new Intent(Update_Delete_Dish_Meryenda.this, ChefFoodPanel_BottomNavigation.class));
                                    }
                                });
                ...
                progressDialog = new ProgressDialog(Update_Delete_Dish_Meryenda.this);
                databaseReference = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child("Meryenda").child(Region).child(City).child(useridd).child(ID);
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Dishname.setText(updateDishModel.getDishes());
                        pri.getEditText().setText(updateDishModel.getPrice());
                        Glide.with(Update_Delete_Dish_Meryenda.this).load(updateDishModel.getImageURL()).into(imageButton);
        ...
        if (imageuri != null) {
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(Update_Delete_Dish_Meryenda.this, "Failed : " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
    ...
    private void updatedesc(String uri) {
        ...
        firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child("Meryenda").child(Region).child(City)
                .child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID)
                .setValue(info).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressDialog.dismiss();
                Toast.makeText(Update_Delete_Dish_Meryenda.this, "Dish Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ((ImageButton) findViewById(R.id.Mimageupload)).setImageURI(result.getUri());
