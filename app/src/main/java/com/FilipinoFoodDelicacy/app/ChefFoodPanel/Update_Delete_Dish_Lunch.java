...
public class Update_Delete_Dish_Lunch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update__delete__dish_lunch);

        desc = (TextInputLayout) findViewById(R.id.Ldescription);
        qty = (TextInputLayout) findViewById(R.id.Lquantity);
        pri = (TextInputLayout) findViewById(R.id.Lprice);
        Dishname = (EditText) findViewById(R.id.Ldish_name);
        imageButton = (ImageButton) findViewById(R.id.Limageupload);
        Update_dish = (Button) findViewById(R.id.LUpdatedish);
        Delete_dish = (Button) findViewById(R.id.LDeletedish);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Delete_dish.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(Update_Delete_Dish_Lunch.this);
                        builder.setMessage("Are you sure you want to Delete Dish");
                        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {

                                firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child("Lunch").child(Region).child(City).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID).removeValue();

                                AlertDialog.Builder food = new AlertDialog.Builder(Update_Delete_Dish_Lunch.this);
                                food.setMessage("Your Dish has been Deleted");
                                food.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {

                                        startActivity(new Intent(Update_Delete_Dish_Lunch.this, ChefFoodPanel_BottomNavigation.class));
                                    }
                                });
                ...
                progressDialog = new ProgressDialog(Update_Delete_Dish_Lunch.this);
                databaseReference = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child("Lunch").child(Region).child(City).child(useridd).child(ID);
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Glide.with(Update_Delete_Dish_Lunch.this).load(updateDishModel.getImageURL()).into(imageButton);
        ...
        if (imageuri != null) {
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(Update_Delete_Dish_Lunch.this, "Failed : " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
    ...
    private void updatedesc(String uri) {
        ...
        firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child("Lunch").child(Region).child(City)
                .child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID)
                .setValue(info).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressDialog.dismiss();
                Toast.makeText(Update_Delete_Dish_Lunch.this, "Dish Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ((ImageButton) findViewById(R.id.Limageupload)).setImageURI(result.getUri());
