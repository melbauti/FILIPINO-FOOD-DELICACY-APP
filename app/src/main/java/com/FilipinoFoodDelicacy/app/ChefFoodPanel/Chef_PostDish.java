...
public class Chef_PostDish extends AppCompatActivity {
    ...
    String[] SetSelected={"Please Select","Breakfast","Lunch","Meryenda"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SetSpinner = (Spinner) findViewById(R.id.Set);
        ...
        SetSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                SetString = value.toString().trim();

                if (SetString.equals("Please Select")) {
                    ArrayList<String> list = new ArrayList<>();
                    list.addAll(Arrays.asList(SetSelected));

                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Chef_PostDish.this, android.R.layout.simple_spinner_item, list);
                    SetSpinner.setAdapter(arrayAdapter);
                }
                SetTextView.setText(SetString);
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(SetString).child(Region).child(City).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUId)
